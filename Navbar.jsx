...
const Navbar = () => {
  ...
  return (
    <div className="navbar py-5 flex place-items-center justify-between">
        <div className="logo">
            <h1 className="text-3xl font-bold bg-white text-black p-1 md:bg-transparent md:text-white">Rizki.fernand</h1>
        </div>
